        <footer class="index">
            <p><strong><span class="glyphicon glyphicon-globe"></span> Karloz Web &copy;</strong></p>
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <!--Menu Inferior-->
                        <div class="menufooter" id="menuInferior">
                        </div>
                    </div>
    ...
    <script>
        ...
        ga('create','UA-66180704-1','auto');ga('send','pageview');
    </script>    
</html>