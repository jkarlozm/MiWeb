						...
						<fieldset style="width: 80%; margin:auto; margin-bottom: 15px;">
							...
							<blockquote>
								<dl>
									...
									<dd><a href="'.$_POST["siteWeb"].'" style="text-decoration: none;">'.$_POST["siteWeb"].'</a></dd>
									<dt><strong>Número telefónico:</strong></dt>
									<dd><a href="'.$_POST["telphone"].'" style="text-decoration: none;">'.$_POST["telphone"].'</a></dd>
								</dl>
							</blockquote>
						</fieldset>
